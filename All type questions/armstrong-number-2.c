...
int main() {
    int num, r, sum = 0, temp;
     // Declare variables for the input number, remainder, sum, and a temporary variable.
    ...
    if (sum == temp) 
    // If the sum of cubes of digits is equal to the original number.

        printf("%d is an Armstrong number.\n", temp);
         // Print that it's an Armstrong number.
    else
        printf("%d is not an Armstrong number.\n", temp); 
        // Otherwise, print that it's not an Armstrong number.
